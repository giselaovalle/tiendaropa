...
public class Compra {
    ...
    //obtener y colocar la clase de bodega
    ...
    ArrayList<Compra> lasCompras = new ArrayList<>();
        try {
            ...
            while (rs.next()) {                
                ...
                unaCompra.setIdCompra( rs.getInt("idCompra"));
                unaCompra.setIdCompra( rs.getInt("idClienteCompra"));
                unaCompra.setIdCompra( rs.getInt("idProductoCompra"));
                lasCompras.add(unaCompra);
            }
        } catch (SQLException e) {
            System.out.println("datos no encontrados"  +e.getMessage());
        }
